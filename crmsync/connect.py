"""Native cognis-connect emit for crmsync — forward findings to any platform.

Maps crmsync's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    crmsync ... --format json | crmsync-emit --to stix
    crmsync-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
