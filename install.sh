#!/usr/bin/env sh
# Universal installer for crmsync. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/crmsync.git"
echo "Installing crmsync ..."
